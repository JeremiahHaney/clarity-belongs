...
## Product facts
- Slug: `broken-link`
- Public URL: https://claritybelongs.com/products/broken-link
- Product type: single-link availability watch
...
- Promise: An important external or internal public link breaks after publication.
...
**Problem:** An important external or internal public link breaks after publication.

**Primary audiences:** site owners, content teams, web developers

**Job to be done:** "When one link matters, I want it checked repeatedly so I know when it breaks or recovers."

## Search intent
Current intent cluster to validate and expand with Search Console after launch:
- broken link monitor
- monitor a link for 404
- link uptime monitor

Do not manufacture volume numbers. Use actual query/impression data once Search Console has enough traffic.

## Alternatives / competitors
site crawlers, Screaming Frog, link-check plugins, manual checks. The behavioral alternative is manual checking; the broad substitute is a general automation/monitoring platform.

## Demonstration use cases
1. documentation dependency link breaks
2. partner link goes 404
3. download link recovers

Demonstrations must use safe public targets and show what Clarity actually records.

## Distribution map
Search/Learn; webdev/content operations communities; product directories
...
## Share loop
Share a public link failure/recovery timeline.
