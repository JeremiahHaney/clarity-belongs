...
public sealed class ContactService(ClarityDbContext db)
{
    ...
    {
        var requestedCategory = category?.Trim() ?? string.Empty;
        var normalizedCategory = Categories.Contains(requestedCategory)
            ? requestedCategory
            : "General";
        ...
        var normalizedPath = sourcePath?.Trim();
        ...
        var submission = new ContactSubmission
        {
            ...
            SourcePath = string.IsNullOrWhiteSpace(normalizedPath)
                ? null
                : normalizedPath,
