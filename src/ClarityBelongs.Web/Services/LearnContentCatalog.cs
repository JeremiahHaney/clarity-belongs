...
public sealed class LearnContentCatalog
{
    ...
    [
        new(
            ...
            "How to monitor a website for changes",
            "A simple way to stop revisiting the same webpage and get a useful history when it changes.",
            ...
            [
                ...
                "Review meaningful changes and their before/after evidence in My Clarity."
            ]),
        new(
            ...
            [
                ...
                "Does every tiny page difference create an alert?",
            ...
            [
                ...
                "Clarity stores normalized snapshots and compares them over time.",
                "Open the change history when something meaningful differs."
            ]),
        new(
            ...
            [
                ...
                "Clarity checks stable availability state rather than treating response-time variation as a content change.",
                "Failure creates an attention event.",
                "Recovery is recorded when the endpoint responds again."
            ]),
        new(
            "ssl-certificate-expiration-alert",
            "SSL certificate expiration alert",
            "Track a public TLS certificate and get reminders before its expiration becomes urgent.",
            "SSL expiration alert",
            "ssl-expiration",
            "SSL Expiration Monitor",
            [
                "How early does Clarity remind me?",
            ...
            [
                ...
                "Expiration reminders are deduplicated at 30, 14, 7, and 1 day.",
                "Certificate changes remain visible in history."
            ]),
        new(
            "domain-expiration-reminder",
            "Domain expiration reminder",
            "Keep a domain's published registry expiration date visible and get reminders before renewal is due.",
            "domain expiration reminder",
            "domain-expiration",
            ...
            [
                ...
                "Upcoming expiration thresholds create reminders when data is available."
            ]),
        new(
            "dns-change-monitor",
            "DNS change monitor",
        ...
        new(
            ...
            "Website Change Monitor",
            [
                "Can I monitor a competitor pricing page?",
            ...
            [
                ...
                "Use history to review later differences."
            ]),
        new(
            "monitor-terms-and-privacy-policy-changes",
            "Monitor terms and privacy policy changes",
            "Follow a public terms or privacy page and keep a timeline of meaningful changes.",
        ...
        new(
            ...
            [
                ...
                "Review new changes from My Clarity instead of repeatedly visiting the page."
            ]),
        new(
            "what-is-website-change-monitoring",
            "What is website change monitoring?",
            "Website change monitoring automatically revisits a public page, stores a baseline, compares later observations, and surfaces differences.",
            "what is website change monitoring",
            "website-change",
            "Website Change Monitor",
            [
                "How is change monitoring different from uptime monitoring?",
                "Why keep snapshots instead of only sending an email?",
                "What kinds of pages are useful to monitor?"
            ],
            [
                "Uptime asks whether the site responds.",
                "Change monitoring asks whether the observed content state differs.",
                "History makes later alerts explainable.",
        ...
        new(
            ...
            [
                ...
                "Why do plans have cadence limits?",
            ...
            [
                ...
                "Avoid unnecessary checks that add cost without changing the decision.",
                "Clarity plan limits are intentionally tied to ongoing delivery cost."
            ])
    ];
